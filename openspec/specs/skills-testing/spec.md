# skills-testing Specification

## Purpose
Test Agent Skills - deterministic frontmatter parsing and validation, LLM-judge and agent-mode activation checks with pass@k, and discoverability. Shipped as `SkillsLibrary`.
