# subagent-testing Specification

## Purpose
Test SubAgents - deterministic config-drift checks and delegation extraction, plus agent-mode routing accuracy with pass@k. Shipped as `SubagentsLibrary`.
