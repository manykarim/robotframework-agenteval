...
Single-implementation configuration resolution: one 4-layer precedence chain, per-key provenance, one resolution pass per library import, and a single `Get Effective Config` keyword.
