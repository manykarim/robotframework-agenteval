...
`@guarded_fanout` budget-enforcement contract after the no-budget fast path: calls with nothing to enforce run without metering overhead; budgeted calls keep the full 3-layer enforcement unchanged.
